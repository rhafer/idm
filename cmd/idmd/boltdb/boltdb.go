...
need to	be correctly sorted, so that parent entries are created before their children.`,
	...
	loadLDIFCmd.MarkFlagRequired("input-file")
	loadLDIFCmd.MarkFlagRequired("ldap-base-dn")
	...
	exportLDIFCmd.MarkFlagRequired("ldap-base-dn")
...
func loadLDIF(cmd *cobra.Command, args []string) error {
...
func exportLDIF(cmd *cobra.Command, args []string) error {
